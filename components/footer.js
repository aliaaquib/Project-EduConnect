            ...
            <div>
              ...
              >
                <Image
                  ...
                  className="w-8"
                />
                <span>Project Edu Connect</span>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Your support can be the catalyst for transformative change.
              Consider making a donation to Project Edu Connect and help us  to
              support education of marginalized and minority community. 
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link
                  key={index}
                  href={item.link}
                  className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-green-900 hover:font-semibold focus:text-green-900 focus:bg-green-100 focus:outline-none dark:focus:bg-trueGray-700"
                >
                  {item.label}
                </Link>
              ))}
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {legal.map((item, index) => (
                <Link
                  key={index}
                  href={item.link}
                  className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:font-semibold hover:text-green-900 focus:text-green-900 focus:bg-green-100 focus:outline-none dark:focus:bg-trueGray-700"
                >
                  {item.label}
                </Link>
              ))}
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          <p className="md:flex items-center justify-center">
            ...
            <a
              ...
              className="mx-1"
            >
              <p className="text-green-900 hover:text-green-950 hover:font-semibold">Socio Team</p>
              {/* <Image
